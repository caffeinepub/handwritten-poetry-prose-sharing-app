...
import type { ExternalBlob as _ExternalBlob, PostVisibility as _PostVisibility, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, WritingPost as _WritingPost, WritingType as _WritingType, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: string, arg2: string | null, arg3: ExternalBlob, arg4: WritingType, arg5: PostVisibility): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(arg0, arg1, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg3), to_candid_WritingType_n12(this._uploadFile, this._downloadFile, arg4), to_candid_PostVisibility_n14(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPosts(): Promise<Array<WritingPost>> {
        if (this.processError) {
            try {
    ...
    async getPost(arg0: string): Promise<WritingPost> {
        if (this.processError) {
            try {
                const result = await this.actor.getPost(arg0);
                return from_candid_WritingPost_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPostsByType(arg0: WritingType): Promise<Array<WritingPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPostsByType(to_candid_WritingType_n12(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isUserSubscribed(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isUserSubscribed();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PostVisibility_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostVisibility): PostVisibility {
...
async function from_candid_WritingPost_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WritingPost): Promise<WritingPost> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_WritingType_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WritingType): WritingType {
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        author: value.author,
        writingType: from_candid_WritingType_n19(_uploadFile, _downloadFile, value.writingType),
        ...
        visibility: from_candid_PostVisibility_n23(_uploadFile, _downloadFile, value.visibility)
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "prose" in value ? WritingType.prose : "poetry" in value ? WritingType.poetry : value;
}
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "publicPost" in value ? PostVisibility.publicPost : "privatePost" in value ? PostVisibility.privatePost : "linkOnly" in value ? PostVisibility.linkOnly : value;
}
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WritingPost>): Promise<Array<WritingPost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_WritingPost_n17(_uploadFile, _downloadFile, x)));
}
...
function to_candid_PostVisibility_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PostVisibility): _PostVisibility {
    return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_UserRole_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_WritingType_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WritingType): _WritingType {
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WritingType): {
    prose: null;
} | {
    poetry: null;
} {
    return value == WritingType.prose ? {
        prose: null
    } : value == WritingType.poetry ? {
        poetry: null
    } : value;
}
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PostVisibility): {
    publicPost: null;
} | {
    privatePost: null;
} | {
    ...
    return value == PostVisibility.publicPost ? {
        publicPost: null
    } : value == PostVisibility.privatePost ? {
        privatePost: null
    } : value == PostVisibility.linkOnly ? {
        linkOnly: null
    } : value;
}
